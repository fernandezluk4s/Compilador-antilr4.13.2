...
public class LinguagemALexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "MUL", "DIV", "MOD", "PLUS", "MINUS", 
			"POW", "EQ", "NEQ", "LE", "GE", "LT", "GT", "AND", "OR", "NOT", "TRUE", 
			"FALSE", "ID", "INT", "FLOAT", "WS", "COMMENT"
		};
	}
	...
	public LinguagemALexer(CharStream input) {
		super(input);
